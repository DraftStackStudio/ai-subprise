  ...
  return (
    <header className="main-header">
      ...
      <div className="header-actions">
        {activeSection === "dashboard" && onBackToDashboard ? (
          <button className="btn-sm btn-sm-ghost button-with-icon" onClick={onBackToDashboard} type="button">
        ...
        {activeSection === "billing" && onAddPastBilling ? <button className="btn-sm btn-sm-primary" onClick={onAddPastBilling} type="button">+ Add Payment</button> : null}
