  ...
  return <div className="welcome-modal-overlay billing-past-entry-overlay" onClick={(event) => { if (event.target === event.currentTarget) onCancel(); }} role="presentation">
    <section aria-labelledby="billing-past-entry-title" aria-modal="true" className="welcome-modal billing-past-entry-modal" role="dialog">
      ...
      <div className="billing-past-choice-grid billing-past-entry-choices">
        <button className={mode === "single" ? "is-selected" : ""} onClick={() => setMode("single")} type="button"><span className="billing-past-option-icon" aria-hidden="true"><svg fill="none" viewBox="0 0 20 20"><path d="M4 6.5h11.5A1.5 1.5 0 0 1 17 8v7H5.5A2.5 2.5 0 0 1 3 12.5v-8A1.5 1.5 0 0 1 4.5 3H15"/><circle cx="13.5" cy="11" fill="currentColor" r="1"/></svg></span><strong>Single Payment</strong><span>Record a previous purchase, top-up or other irregular payment.</span></button>
